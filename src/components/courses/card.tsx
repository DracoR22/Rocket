...
const Card = ({ id, imageSrc, onClick, title, active, disabled }: Props) => {
  return (
    <div onClick={() => onClick(id)} className={cn('h-full border-2 rounded-xl border-b-4 hover:bg-black/5 cursor-pointer active:border-b-2 flex flex-col items-center justify-between p-6 m-1 min-h-[217px] min-w-[200px]',
