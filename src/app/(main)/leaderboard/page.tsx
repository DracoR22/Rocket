...
import { getTopTenUsers, getUserProgress, getUserSubscription } from "@/server/db/queries"
      ...
      <div className="flex flex-row-reverse gap-[48px] px-6">
         ...
         <FeedWrapper>
           <div className="w-full flex flex-col items-center">
              ...
              <h1 className="text-center font-bold text-neutral-800 dark:text-neutral-300 text-2xl my-6">
                  Leaderboard
              </h1>
             ...
             {leaderboard.map((userProgress, i) => (
                 <div key={userProgress.userId} className="flex items-center h-full w-full p-2 px-4 rounded-xl hover:bg-gray-200/50 dark:hover:bg-gray-800">
                    <p className="font-bold text-lime-700 dark:text-lime-300 mr-4">
                        {i + 1}
                    </p>
                    <Avatar className="border bg-green-500 h-12 w-12 ml-3 mr-6">
                        <AvatarImage className="object-cover" src={userProgress.userImageSrc}/>
                    </Avatar>
                    <p className="font-bold text-neutral-800 dark:text-neutral-300 flex-1">
