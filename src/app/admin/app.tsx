...
const App = () => {
  return (
    <Admin dataProvider={dataProvider}>
        ...
        <Resource name="challenges" list={ChallengeList} create={ChallengeCreate} edit={ChallengeEdit} recordRepresentation='title'/>
        <Resource name="challengeOption" list={ChallengeOptionList} create={ChallengeOptionCreate} edit={ChallengeOptionEdit } recordRepresentation='title'/>
    </Admin>
  )
}
